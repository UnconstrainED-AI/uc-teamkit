...
```
git clone [REPO_URL_GOES_HERE] my-assistant
```
...
- Make sure Claude Code is running in Terminal with the `--channels` flag
- Make sure you completed the pairing step (Step 8)
- Try restarting: press Ctrl + C, then run the start command again
